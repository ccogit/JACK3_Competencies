...
public class ExerciseBusiness extends AbstractBusiness {
     ...
     * </ul>
     *
     * @param exercise for which should be checked, if it is deletable
     * @param user     who wants to delete the exercise
     ...
     *
     * @throws ActionNotAllowedException If the user does not have edit rights on the exercise's parent folder.
     */
     ...
     *
     * @param exercise     The exercise of which a copy is to be made
     * @param targetFolder The Parent Folder for the copy of the Exercise
     * @param newName      The name for the copy
     * @param user         The user that performs the action.
     * @return New exercise
     * @throws ActionNotAllowedException If either the user is not allowed to read the Exercise configuration or the user is not allowed to
     ...
     *
     * @param folder Folder containing the exercises to be listed.
     ...
     *
     * @throws SubmissionException If the user has reached the limit of submissions or the course record is closed.
     */
    ...
    public List<Exercise> getAllExercisesForContentFolderListBySubject(List<ContentFolder> folderList, Subject subject) {
        return exerciseService.getAllExercisesForContentFolderListBySubject(folderList, subject);
    }
