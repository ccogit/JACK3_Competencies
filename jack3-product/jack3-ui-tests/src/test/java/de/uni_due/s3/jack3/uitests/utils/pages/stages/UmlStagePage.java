...
public class UmlStagePage {
	...
	private final String GREQL_RULE_TEXT = "exerciseEdit:tabs0:greqlRuleText";
	...
	public UmlStagePage(String stageIndex) {
	...
	public void setGREQLRuleText (String text) {
		waitClickable(By.id(GREQL_RULE_TEXT.replace("0", STAGE_INDEX)));
		find((GREQL_RULE_TEXT.replace("0", STAGE_INDEX))).sendKeys(text);
	}
