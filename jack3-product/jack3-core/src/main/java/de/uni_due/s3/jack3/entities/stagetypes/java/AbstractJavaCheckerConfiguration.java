...
@Audited
@Entity
@XStreamAlias("AbstractJavaCheckerConfiguration")
public abstract class AbstractJavaCheckerConfiguration extends CheckerConfiguration {
	...
	@JoinTable(
			name = "abstractjavacheckerconfiguration_sourcefiles",
			joinColumns = @JoinColumn(name = "abstractjavacheckerconfiguration_id"),
	...
	@ManyToMany(fetch = FetchType.EAGER)
	@JoinTable(
			name = "abstractjavacheckerconfiguration_libraryfiles",
			joinColumns = @JoinColumn(name = "abstractjavacheckerconfiguration_id"),
			inverseJoinColumns = @JoinColumn(name = "exerciseresource_id"))
	@DeepCopyOmitField(
		reason = "The refernces for the exerciseResources must be set by the caller of the deepCopy method")
	...
	protected void copyFrom(AbstractJavaCheckerConfiguration original) {
