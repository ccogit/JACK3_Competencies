...
@NamedQuery(
        name = Course.COURSES_REFERENCING_SUBCOMPETENCE, //
        query = "SELECT c FROM Course c " //
                + "JOIN CompetenceGoal cg on cg.course=c.id " //
...
public class Course extends AbstractCourse implements DeepCopyable<Course> {
    ...
    /**
     * Name of the query that returns all courses, which have a reference to the given subcompetence
     */
    public static final String COURSES_REFERENCING_SUBCOMPETENCE = "Course.coursesReferencingSubcompetence";
